...
# os.environ["PATH"] = os.environ["PATH"] + ":/home/eric/.conda/envs/rwkv/bin/ninja"
# from pytorch_lightning.loggers import TensorBoardLogger

# logger = TensorBoardLogger("tb_logs", name="rwkv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb", default="./output", type=str)  # wandb project name. if "" then don't use wandb
    parser.add_argument("--proj_dir", default="out", type=str)
    parser.add_argument("--random_seed", default="-1", type=int)

    parser.add_argument("--data_file", default="", type=str)
    parser.add_argument("--my_data_file", default="", type=str)
...
"""
    ...
    from src.ft_dataset import FtDataset

    train_data = FtDataset(args.my_data_file, args.ctx_len)
