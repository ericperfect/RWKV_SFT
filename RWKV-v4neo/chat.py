...
args.MODEL_NAME = '/data/eric/model/RWKV-4-Raven-7B-v12-Eng49-Jpn1-20230530-ctx8192'
args.n_layer = 32
args.n_embd = 4096
args.ctx_len = 4096

# Modify this to use LoRA models; lora_r = 0 will not use LoRA weights.
args.MODEL_LORA = '/home/eric/RWKV-LM-LoRA/RWKV-v4neo/output/rwkv-1'
args.lora_r = 16
args.lora_alpha = 32
...
def on_message(message):
    ...
    if msg == '+reset':
        ...
        for i in range(4096):
            ...
            out = run_rnn([token], newline_adj=0)
